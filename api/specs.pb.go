...
type ContainerSpec struct {
	...
	NetworkMode string        `protobuf:"bytes,20,opt,name=networkMode,proto3" json:"networkMode,omitempty"`
}
...
func (this *ContainerSpec) GoString() string {
	...
	s = append(s, "NetworkMode: "+fmt.Sprintf("%#v", this.NetworkMode)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *ContainerSpec) MarshalTo(data []byte) (int, error) {
	...
	if len(m.NetworkMode) > 0 {
		...
		data[i] = 0x1
		i++
		i = encodeVarintSpecs(data, i, uint64(len(m.NetworkMode)))
...
func (this *ContainerSpec) String() string {
	...
	s := strings.Join([]string{`&ContainerSpec{`,
		...
		`NetworkMode:` + fmt.Sprintf("%v", this.NetworkMode) + `,`,
		`}`,
	}, "")
	return s
}
...
var fileDescriptorSpecs = []byte{
	...
	,
}
